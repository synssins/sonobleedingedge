...
Note: The HA addon version uses StateStore instead of AppConfig for persistence.
"""
...
async def init(app_context: Any) -> bool:
    ...
    Args:
        app_context: Application context containing state_store and services
                    For HA addon: expects state_store and audio_path
